...
from config.settings.subsettings.apps import APPS, DEV_APPS, DJANGO_APPS, THIRD_PARTY_APPS
from config.settings.subsettings.middleware import CUSTOM_MIDDLEWARE, DEV_MIDDLEWARE, MIDDLEWARE
